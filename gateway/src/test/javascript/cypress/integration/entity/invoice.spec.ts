...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2022-01-08T07:27:00.741Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-01-08T18:25:33.319Z',
    paymentAmount: 75679,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-08T08:25').should('have.value', '2022-01-08T08:25');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-01-08T03:41').should('have.value', '2022-01-08T03:41');
