...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2022-01-08T06:54:31.728Z', status: 'COMPLETED', code: 'paradigm Account adapter' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-01-08T13:16').should('have.value', '2022-01-08T13:16');
