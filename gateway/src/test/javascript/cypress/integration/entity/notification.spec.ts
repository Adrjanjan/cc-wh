...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-01-08T10:44:43.480Z',
    sentDate: '2022-01-08T02:57:46.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-07T19:02').should('have.value', '2022-01-07T19:02');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2022-01-07T19:07').should('have.value', '2022-01-07T19:07');
